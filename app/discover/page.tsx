export default function DiscoverPage() {
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-[#0f172a] dark:to-slate-900">
			<div className="max-w-4xl mx-auto px-4 py-16">
				{/* Title */}
				<h1 className="text-5xl font-bold text-gray-900 dark:text-slate-100 mb-6 text-center">
					Discover your app
				</h1>
				{/* Main Description Card */}
				<div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-md dark:shadow-lg dark:shadow-black/30 text-center mb-16">
					...
					<p className="text-base text-gray-500 dark:text-slate-400 max-w-2xl mx-auto mb-2">
					...
					<p className="text-sm text-gray-400 dark:text-slate-500 max-w-2xl mx-auto">
				...
				<div className="grid md:grid-cols-2 gap-6 mb-10">
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md dark:shadow-lg dark:shadow-black/30 flex flex-col gap-2">
				...
				<div className="grid md:grid-cols-2 gap-6">
					...
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md dark:shadow-lg dark:shadow-black/30 flex flex-col justify-between">
						<div>
						...
						<a
							...
							className="mt-auto block w-full bg-blue-500 dark:bg-blue-600 hover:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors text-center text-sm"
						>
							Visit CryptoKings
						</a>
					</div>
					...
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md dark:shadow-lg dark:shadow-black/30 flex flex-col justify-between">
						<div>
							...
							<p className="text-gray-700 dark:text-slate-300 mb-4 text-sm">
								...
								<span className="font-bold text-blue-600 dark:text-blue-400">$4,000+</span>{" "}
								last quarter."
							</p>
						</div>
						<a
